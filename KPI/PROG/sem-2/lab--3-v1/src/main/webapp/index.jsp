...
<%@ page import="com.example.lab3.ParamUtils" %>
...
<head>
    ...
    %>
    <%
        CookiesService cookiesUtils = new CookiesService(request);
        if (cookiesUtils.findCookieValue("aFrom") != null) {
            {
                params = ParamUtils.setParamsFromCookies(cookiesUtils);
            }
        }
        if (request.getParameter("aFrom") != null) {
